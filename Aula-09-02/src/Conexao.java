...
public class Conexao {
	public Connection conectar() {
		try {
			...
			/*
			 * // Conexão SQL Server Connection conn;
			 * Class.forName("com.microsoft.sqlserver.jdbc.SQLServerDriver");
			 * System.out.println("Driver JDBC encontrado!");
			 * 
			 * String bdUrl = "jdbc:sqlserver://LAPTOP-TV548JR1\\MSSQL;DatabaseName=alpoo";
			 * String bdUsuario = "ale"; String bdSenha = "ale"; conn =
			 * DriverManager.getConnection(bdUrl,bdUsuario,bdSenha);
			 */

			/*
			 * Connection conn; Class.forName("com.mysql.cj.jdbc.Driver");
			 * System.out.println("Driver JDBC encontrado!");
			 * 
			 * //String bdUrl = "jdbc:mysql://localhost:3306/alpoo"; String bdUrl =
			 * "jdbc:mysql://localhost:3306/alpoo?useTimezone=true&serverTimezone=UTC";
			 * String bdUsuario = "ale"; String bdSenha = "ale";
			 * 
